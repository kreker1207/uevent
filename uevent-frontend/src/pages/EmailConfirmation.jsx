                ...
                <div> 
                    {
                        state.success ? 
                        <div className='info'>
                            <div className={'circle'}><div><img src={require('../assets/emailConfirm.png')} alt="confirmed" /></div></div>
                        ...
                        :
                        <div className='info'>
                            <div className={'circle'}><img src={require('../assets/emailReject.png')} alt="rejected" /></div>
